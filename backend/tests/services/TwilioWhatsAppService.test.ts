import { TwilioWhatsAppService } from '../../src/services/communication/TwilioWhatsAppService';
...
describe('TwilioWhatsAppService', () => {
  ...
  describe('constructor', () => {
    ...
    it('should handle missing credentials gracefully', () => {
      ...
      const serviceWithoutCreds = new TwilioWhatsAppService();
  ...
  describe('sendMessage', () => {
    it('should send WhatsApp message successfully', async () => {
      ...
      const result = await service.sendMessage('+46722083756', 'Test message');
    ...
    it('should handle phone numbers with whatsapp: prefix', async () => {
      ...
      const result = await service.sendMessage('whatsapp:+46722083756', 'Test message');
    ...
    it('should return false when client is not configured', async () => {
      ...
      const unconfiguredService = new TwilioWhatsAppService();
      const result = await unconfiguredService.sendMessage('+46722083756', 'Test message');
  ...
  describe('sendTemplate', () => {
    it('should send template message with parameters', async () => {
      ...
      const result = await service.sendTemplate('+46722083756', 'welcome', ['John Doe']);
    ...
    it('should send template message without parameters', async () => {
      ...
      const result = await service.sendTemplate('+46722083756', 'welcome');
